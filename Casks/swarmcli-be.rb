...
cask "swarmcli-be" do
  disable! date: "2026-09-11", because: "has been renamed to `swarmcli`, which installs the same build"

  name "swarmcli-be"
  desc "Docker Swarm TUI management tool (retired: install swarmcli)"
